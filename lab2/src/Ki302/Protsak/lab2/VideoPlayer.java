...
public class VideoPlayer {
    ...
    public void play(String videoName) throws IOException {
        if (mediaLibrary.hasVideo(videoName)) {
            this.isPlaying = true;
            this.currentVideo = videoName;

            logger.log(String.format("Початок відтворення відео: %s", videoName));
            System.out.printf("Початок відтворення відео: %s\n", videoName);
        } else {
            logger.log(String.format("Відео не знайдено: %s", videoName));
            System.out.printf("Відео не знайдено: %s\n", videoName);
        }
    }
    ...
    public void pause() throws IOException {
        if (isPlaying) {
            ...
            logger.log(String.format("Пауза відтворення: %s", currentVideo));
            System.out.printf("Пауза відтворення: %s\n", currentVideo);
        }
    }
    ...
    public void resume() throws IOException {
        if (!isPlaying && !currentVideo.isEmpty()) {
            this.isPlaying = true;

            logger.log(String.format("Відновлення відтворення: %s", currentVideo));
            System.out.printf("Відновлення відтворення: %s\n", currentVideo);
        }
    }
